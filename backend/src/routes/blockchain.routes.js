...
import { blockchainWriteLimiter } from '../middlewares/ai-rate-limit.js'
...
router.post('/anchor/:entityType/:entityId', blockchainWriteLimiter, validateObjectIdParams('entityId'), blockchainController.anchor)
